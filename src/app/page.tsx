...
import { 
  BookOpen, Cuboid, MonitorPlay, FileText, 
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFCF8] text-stone-800 font-sans selection:bg-emerald-100">
      ...
      <header className="relative pt-40 pb-24 flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        <motion.div 
        ...
        >
          <h1 className="text-6xl md:text-8xl font-serif font-medium text-stone-900 tracking-tight leading-tight mb-8">
            Learn beyond <br className="hidden md:block"/> the flat page.
          </h1>
          <p className="text-xl md:text-2xl text-stone-500 font-light max-w-2xl mx-auto mb-12">
            Experience the next evolution of STEM education. Spatial, AI-guided, and deeply intuitive.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#philosophy" className="px-8 py-4 bg-stone-100 text-stone-800 rounded-full font-medium hover:bg-stone-200 transition-colors">
              Explore our vision
            </a>
          </div>
        </motion.div>

        {/* Kapi Mascot Integration */}
        <motion.div 
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 0.2, duration: 1 }}
          className="mt-16 relative w-64 h-64 md:w-80 md:h-80 drop-shadow-xl"
        >
           <Image 
             src="/kapi_mascot.png" 
             alt="Kapi AI Mascot" 
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h3 className="text-4xl md:text-5xl font-serif text-stone-900 leading-tight mb-6">
              Enhancing tradition <br/> with modern intelligence.
            </h3>
            <div className="space-y-6 text-lg text-stone-500 font-light leading-relaxed">
              <p>
                Education shouldn't force you to discard the traditional methods of learning; it should elevate them. Our vision at Kapikitab is to provide the highest quality education by bridging the gap between proven pedagogical wisdom and cutting-edge technology.
              </p>
              <p>
                By integrating artificial intelligence and augmented reality, we aren't just digitizing textbooks—we are creating a personalized, interactive environment where understanding comes naturally, and every student receives the attention of a dedicated tutor.
              </p>
            </div>
          </div>
          <div className="relative h-96 rounded-3xl bg-[#FDFCF8] border border-stone-100 shadow-sm flex items-center justify-center overflow-hidden">
            {/* Abstract visual representing traditional + modern */}
      ...
      {/* 2. Simulation Section (Dark/Emerald Theme for contrast) */}
          ...
          <div className="w-full md:w-1/2 space-y-8">
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-emerald-200/70 font-light">Bring complex concepts into your physical room using your device's camera.</p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
      ...
      {/* 3. Solution Section (Current Tools) */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-3xl border border-stone-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-stone-500 font-light text-sm">High-quality, distraction-free cinematic lessons that break down heavy topics into digestible concepts.</p>
            </div>

            <div className="bg-white p-8 rounded-3xl border border-stone-200 shadow-sm hover:shadow-md transition-shadow">
              <FileText className="w-10 h-10 text-emerald-700 mb-6" />
              <h4 className="text-xl font-medium text-stone-900 mb-3">PYQ & Resources</h4>
              <p className="text-stone-500 font-light text-sm">Deeply cataloged Previous Year Questions, structured notes, and tailored resources to align with your exact curriculum.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl border border-stone-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-stone-500 font-light text-sm">A rigorous, adaptive practice arena that tests your knowledge and fortifies your weak points dynamically.</p>
            </div>
            ...
            <div className="bg-emerald-50 p-8 rounded-3xl border border-emerald-100 shadow-sm hover:shadow-md transition-shadow lg:col-span-3 flex flex-col md:flex-row items-center justify-between gap-8">
              <div>
                ...
                <p className="text-emerald-700 font-light max-w-2xl">
                  Stuck on a problem? Upload a photo of your handwritten equation. Our OCR and logic engine will break it down into a step-by-step pathway, helping you understand the 'how' and 'why', not just the final answer.
                </p>
              </div>
