    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-emerald-50/50 via-[#FDFCF8] to-[#FDFCF8] relative px-4">
      ...
      >
        <div className="flex justify-center mb-6">
          <div className="h-12 w-12 bg-emerald-50 rounded-full flex items-center justify-center text-emerald-700">
            <Sparkles size={24} strokeWidth={1.5} />
          </div>
        </div>
        
        <div className="text-center mb-8">
          <h1 className="text-3xl font-serif text-stone-900 mb-2 tracking-tight">Welcome back</h1>
          <p className="text-stone-500 font-light text-sm">Continue your journey in KapiKitab</p>
        </div>
        ...
        <p className="text-center text-sm text-stone-500 mt-8 font-light">
          Don't have an account? <Link href="/signup" className="text-stone-900 font-medium hover:underline">Sign up</Link>
        </p>
      </motion.div>
    </div>
  );
